            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl">
                    <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-8">
                        Revolutionizing heat through <span className="text-orange-600">Sunshine</span>.
                    </h1>
                    <p className="text-xl text-slate-600 mb-12 leading-relaxed">
                        Founded in 2024, SolarThermal is dedicated to making solar heating technology accessible, affordable, and highly efficient for everyone. We believe that the sun's energy is the key to a sustainable future.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
                    <div className="relative group">
                        ...
                        <div className="aspect-video bg-slate-200 rounded-2xl overflow-hidden flex items-center justify-center text-slate-400">
                            {/* This would be an image of a solar panel installation */}
                            <div className="text-center">
                                <p className="font-medium text-slate-600">Innovation & Technology</p>
                                <p className="text-sm">Solar Thermal Collector Installation</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900 mb-6 font-primary">Our Mission</h2>
                        <p className="text-slate-600 text-lg mb-6 leading-relaxed">
                            Our mission is to lead the global transition to renewable heat. While PV panels handle electricity, heating accounts for over 50% of residential energy consumption. That's where we come in.
                        </p>
                        <ul className="space-y-4">
                            {[
                                "100% Carbon-Neutral Heating",
                                "Patented High-Efficiency Collectors",
                ...
                <div className="bg-slate-50 rounded-[3rem] p-12 md:p-20 text-center">
                    ...
                    <p className="text-slate-600 max-w-2xl mx-auto mb-16">
                        Meet the visionary team behind the most efficient solar thermal technology on the market.
                    </p>
